...
public class AVL {
     ...
     * tambien esta un poco caido hacia la izquierda (balance 1)
    ...
    /*Pertenece: Devuelve verdadero si el elemento recibido por parámetro está en el árbol y falso en caso contrario.
esVacio (): boolean*/
...
//minimoElem (): elemento Recorre la rama correspondiente y devuelve el elemento más pequeño almacenado en el árbol.

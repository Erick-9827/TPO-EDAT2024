...
public class TPO2024 {
    ...
    public static void consultasSobreViajes() {
        ...
        do {
            ...
            switch (opcion) {
                case "1":
                    String a, b;
                    System.out.println("Eligio 1-Obtener el camino de A a B de menor tiempo");
                    System.out.println("Ingrese el nombre de la ciudad A");
                    a = s.nextLine();
                    Ciudad a1 = new Ciudad(a);
                    System.out.println("Ingrese el nombre de la ciudad B");
                    b = s.nextLine();
                    Ciudad b1 = new Ciudad(b);
                    System.out.println(ciudades.caminoMenosPeso(a1, b1));
                    break;
                case "2":
                    System.out
                            .println("Eligio 2-Obtener el camino de A a B que pasa por la menor cantidad de ciudades");
                    System.out.println("Ingrese el nombre de la ciudad A");
                    a = s.nextLine();
                    Ciudad a2 = new Ciudad(a);
                    System.out.println("Ingrese el nombre de la ciudad B");
                    b = s.nextLine();
                    Ciudad b2 = new Ciudad(b);
                    System.out.println(ciudades.caminoMasCorto(a2, b2));
                    break;
                default:
                    System.out.println("Opcion elegida no valida");
                    break;
            }
            System.out.println("Desea ir al menu consultas de viaje? y/n");
            respuesta = s.nextLine().toLowerCase().charAt(0);
        } while (respuesta == 'y');
    }
    ...
    public static void altaPartido() {
        ...
        if (equipo1 != null && equipo2 != null && !equipo1.equals(equipo2)) {
            ...
            ciudad = (Ciudad) ciudades.getElemento(ciudad);
    ...
    public static void partidosEntreEquipos() {
        ...
        Partido temp = new Partido(new Equipo(nombreEquipo1), new Equipo(nombreEquipo2));
        int key = temp.hashCode() % partidos.getSize();
    ...
    public static void darBajaCiudad() {
        ...
        boolean exito = ciudades.eliminarVertice(new Ciudad(ciudad));
        if (exito) {
    ...
    public static void modificarCiudad() {
        ...
        Ciudad ciudad = (Ciudad) ciudades.getElemento(new Ciudad(nombreCiudad1)), ciudad2;
            ...
            do {
                ...
                switch (opcion) {
                    case "1":
                        ...
                        if (!ciudades.pertenece(new Ciudad(nuevoNombre))) {
                    ...
                    case "4":
                        ...
                        ciudad2 = (Ciudad) ciudades.getElemento(new Ciudad(nombreCiudad2));
                        if (ciudad2 != null && !ciudad.equals(ciudad2)) {
                            ...
                            ciudades.insertarArco(ciudad, ciudad2, tiempoVuelo);
                    ...
                    case "5":
                        ...
                        System.out.println("Ingrese el nombre de la otra ciudad");
                        nombreCiudad2 = s.nextLine();
                        ciudad2 = new Ciudad(nombreCiudad2);
                        ciudad2 = (Ciudad) ciudades.getElemento(ciudad2);
                        if (ciudad2 != null && !ciudad.equals(ciudad2)) {
                            if (ciudades.eliminarArco(ciudad, ciudad2)) {
    ...
    public static void darBajaEquipo() {
        ...
        Equipo aux = new Equipo(pais);
        boolean exito = equipos.eliminar(aux);
        if (exito) {
    ...
    public static void modificarEquipo() {
        System.out.println("Ingrese el nombre del pais");
        String pais = s.nextLine();
        Equipo equipo = new Equipo(pais);
        equipo = (Equipo) equipos.getElemento(equipo);
        ...
        if (equipo != null) {
            ...
            switch (opcion) {
                case "1":
                    ...
                    String nuevoNombre = s.nextLine().toUpperCase();
                    Equipo aux = new Equipo(nuevoNombre);
                    if (!equipos.pertenece(aux)) {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case "2":
                    ...
                    min = s.nextLine();
                    Equipo auxMin = new Equipo(min);
                    System.out.println("Ingrese la segunda palabra");
                    max = s.nextLine();
                    Equipo auxMax = new Equipo(max);
                    System.out.println(equipos.listarRango(auxMin, auxMax));
                    break;
                default:
                    System.out.println("Opcion elegida no valida");
                    break;
    ...
    public static void datosEquipo() {
        ...
        String pais = s.nextLine();
        Equipo aux = new Equipo(pais);
        Equipo equipo = (Equipo) equipos.getElemento(aux);
    ...
    public static void cargaInicial() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("archivoEquipos.txt"))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (!exito) {
                    System.out.println("no se inserto equipo");
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("archivoRutas.txt"))) {
            ...
            while ((linea = br.readLine()) != null) {
                String[] datos = linea.split("; ");
                exito = ciudades.insertarArco(new Ciudad(datos[0]), new Ciudad(datos[1]), Integer.parseInt(datos[2]));
                if (!exito) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("archivoPartidos.txt"))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                equipo2 = new Equipo(datos[1]);
                equipo1 = (Equipo) equipos.getElemento(equipo1);
                equipo2 = (Equipo) equipos.getElemento(equipo2);

                // Verifico que los equipos elegidos existan y que sean diferentes
                if (equipo1 != null && equipo2 != null && !equipo1.equals(equipo2)) {
                    Ciudad ciudad = new Ciudad(datos[3]);
                    ciudad = (Ciudad) ciudades.getElemento(ciudad);
                    // Verifico que la ciudad elegida exista y sea sede de la copa
                    if (ciudad != null && ciudad.isSedeDeCopa()) {

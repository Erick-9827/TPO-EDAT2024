...
public class AVL {
    ...
    private NodoAVL eliminarRaiz(NodoAVL raiz) {
        ...
        switch (cantidadHijos(raiz)) {
            ...
            case 1:
                ...
                break;
            case 2:
                retorno = candidatoIzquierdo(raiz);
                break;
            default:
                break;
        }
        ...
        if (subRaiz.getElemento().compareTo(elem) == 0) {
            ...
            switch (cantidadHijos(subRaiz)) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    // Busca el candidato izquierdo
                    remplazo = candidatoIzquierdo(subRaiz);
                    break;
                default:
                    break;
            }
     ...
     * actual por el candidato izquierdo
     */
    private NodoAVL candidatoIzquierdo(NodoAVL nodo) {
        NodoAVL retorno = null;
        boolean exito = false;
        NodoAVL candidatoA = candidatoIzquierdoAux(nodo.getIzquierdo());
    ...
    private NodoAVL candidatoIzquierdoAux(NodoAVL raiz) {
        NodoAVL aux = raiz;
